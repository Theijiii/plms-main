...
-- Generation Time: Feb 06, 2026 at 11:36 PM
...
INSERT INTO `application` (`application_id`, `applicant_id`, `permit_group`, `use_of_permit`, `permit_action`, `simple_complex`, `proposed_date_of_construction`, `expected_date_of_completion`, `total_estimated_cost`, `remarks`) VALUES
(1, 1, 'GROUP B: Hotel / Motel / Dormitory / Townhouse / B', 'Motel', NULL, NULL, '2025-10-24', '2025-11-08', 8574854.00, 'fhsgfhd'),
(2, 13, 'GROUP F: Factory / Plant (Non-Explosive)', 'dsds', NULL, NULL, '2025-11-01', '2025-10-12', 758973985.00, 'sfhsj'),
(3, 14, 'GROUP F: Factory / Plant (Non-Explosive)', 'Factory', NULL, NULL, '2025-10-01', '2025-11-08', 4390589348953.00, '487487238734'),
(4, 15, 'GROUP D: Hospital / Home for the Aged / Government', 'hotel', NULL, NULL, '2025-10-13', '2025-10-13', 445.00, 'dfbmdf');
